...
export type MovieSelectType = typeof MovieTable.$inferSelect;
export type MovieInsertType = typeof MovieTable.$inferInsert;
export type MovieUpdateType = Partial<typeof MovieTable.$inferInsert>;
